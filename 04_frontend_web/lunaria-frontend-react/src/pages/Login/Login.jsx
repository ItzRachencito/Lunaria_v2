                ...
                <div className="card-body">
                    <div className="text-center">
                        ...
                        <p className="card-text text-muted">
                            Ingresa tus credenciales para acceder a Lunaria
                        </p>
                    </div>
                    <div className="mt-4">
                        <form onSubmit={onSubmitHandler}>
                            <div className="mb-4">
                                ...
                                <input type="text" name="email" id="email" placeholder="nombre-ejemplo123@lunaria.com" className="form-control" onChange={onChangeHandler} value={data.email} />
                            </div>
                            <div className="mb-4">
